...
import AggregateCodeGenerator from './aggregate-code-generator.js';
import CompositeCodeGenerator from './composite-code-generator.js';
import { unEscape } from './utils.js';

export default class SingleAggregateProcess {
